...
class getUnsplashData : ObservableObject{
    ...
    func updateData(){
        ...
        let url = "https://api.unsplash.com/search/photos/?page=\(page)&query=nasa&count=255&client_id=2SYpP0gVFVB-jjqu-3wWDBiEVDUYNJGf6YQEt7qtddI"
